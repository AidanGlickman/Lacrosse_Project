...
url = "http://highschoolsports.nj.com/sprockets/game_search_results/?limit=50&season=3909&sport=21&page=" # This url, when combined with a page number, gets a barebones version of the scores table
...
wb.save("football.xlsx") # Save the file
